...
(function() {
  ...
  atom.canvas = new fabric.StaticCanvas('game', {
    backgroundColor: '#fff'
  });
  ...
  window.onresize = function(e) {
    ...
    return typeof atom.resizeCb === "function" ? atom.resizeCb() : void 0;
  };
  ...
  Game = (function() {
    ...
    Game.prototype.run = function() {
      ...
      this.running = true;
      s = function() {
        _this.frameRequest = requestAnimationFrame(s);
        return _this.step();
      };
  ...
  atom.preloadSounds = function(sfx, cb) {
    ...
    for (name in sfx) {
      ...
      _results.push((function(name, url) {
        return atom.loadSound("" + url, function(error, buffer) {
          if (error) {
            console.error(error);
          }
          if (buffer) {
